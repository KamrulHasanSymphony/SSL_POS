...
namespace ShampanPOSUI.Areas.DMS.Controllers
{
    [Authorize]
    [RouteArea("DMS")]
    public class ProductBatchHistoryController : Controller
    {
        private readonly ApplicationDbContext _applicationDb;
        ProductBatchHistoryRepo _repo = new ProductBatchHistoryRepo();
        ...
        public ActionResult CreateEdit(ProductBatchHistoryVM model)
        {
            ...
            ResultVM resultVM = new ResultVM { Status = "Fail", Message = "Error", ExMessage = null, Id = "0", DataVM = null };
            _repo = new ProductBatchHistoryRepo();
        ...
        [HttpGet]
        public JsonResult GetProductBatchHistoryById(GridOptions options, int productId, string tblName)
        {
            ResultVM result = new ResultVM { Status = "Fail", Message = "Error", ExMessage = null, Id = "0", DataVM = null };
            _repo = new ProductBatchHistoryRepo();
            ...
            try
            {
                options.vm.TableName = tblName;
                result = _repo.GetProductBatchHistoryById(options, productId);
