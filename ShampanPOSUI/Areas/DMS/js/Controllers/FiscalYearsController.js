var FiscalYearsController = function (CommonAjaxService) {
    ...
    var init = function () {
        ...
        $("#btnFDt").on('click', function () {
            ...
            let url = '/DMS/FiscalYear/FiscalYearSet?YearStart=' + yearStart + '&YearEnd=' + yearEnd;
    ...
    var GetGridDataList = function () {
        var gridDataSource = new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    url: "/DMS/FiscalYear/GetFiscalYearsGrid",
                    type: "POST",
                    dataType: "json",
                    cache: false
                },
            ...
            columns: [
                ...
                },
                {
                    ...
                    template: function (dataItem) {
                        return `
                            <a href="/DMS/FiscalYear/Edit/${dataItem.Id}" class="btn btn-primary btn-sm mr-2 edit" title="Edit Fiscal Year">
    ...
    function save() {
        ...
        if (operation == 'add') {
            ...
            //$('#fiscalYearDetails').each(function () {
            //    var row = $(this);
        ...
        var url = "/DMS/FiscalYear/CreateEdit"
