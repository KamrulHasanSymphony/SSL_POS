var CommonService = function () {
    ...
    var purchaseOrderIdModal = function (done, fail, dblCallBack, closeCallback) {
        ...
        function initializeDataTable() {
            ...
            $(dataTableId).DataTable({
                ...
                columns: [
                    { data: "Code", title: "Code", width: '15%', visible: false },
                    { data: "SupplierId", visible: false },
                    { data: "SupplierName", title: "Supplier Name", width: '30%' },
                    { data: "SupplierAddress", title: "Supplier Address", width: '30%' },
                    { data: "OrderDate", title: "Order Date", width: '10%' },
                    { data: "DeliveryDateTime", title: "Delivery Date Time", width: '10%' },
                    { data: "Comments", title: "Comments", width: '8%', visible: false }
        ...
        $.ajax({
            //url: '/Common/Common/GetProductData',
            url: '/Common/Common/GetPurchaseOrder',
            method: 'get',
        }).done(onSuccess).fail(onFail);
    };  
    ...
    var purchaseModal = function (done, fail, dblCallBack, closeCallback) {
        debugger;
        var modalId = "#partialModal";
        var dataTableId = "#modalData";
        function showModal(html) {
        ...
        function initializeDataTable() {
            ...
            $(dataTableId).DataTable({
                ...
                lengthMenu: [[10, 25, 50, -1], [10, 25, 50, "All"]],
                ajax: {
                    url: '/Common/Common/_getPurchaseData',
                    type: 'POST',
                    data: function (d) {
                ...
                columns: [
                    ...
                    { data: "PurchaseOrderCode", title: "Purchase Order Code", width: '30%' },
                    { data: "SupplierName", title: "Supplier Name", width: '30%' },
        ...
        $.ajax({
            //url: '/Common/Common/GetProductData',
            url: '/Common/Common/GetPurchase',
            method: 'get',
        }).done(onSuccess).fail(onFail);
    };  

    var paymentpurchaseModal = function (supplierId,done, fail, dblCallBack, closeCallback) {
        debugger;
        var modalId = "#partialModal";
        var dataTableId = "#modalData";
        function showModal(html) {
        ...
        function initializeDataTable() {
            ...
            $(dataTableId).DataTable({
                ...
                lengthMenu: [[10, 25, 50, -1], [10, 25, 50, "All"]],
                ajax: {
                    url: '/Common/Common/_getPurchaseDatabySupplier',
                    type: 'POST',
                    data: function (d) {
                        d.SupplierId = supplierId;   // 🔥 PASS supplierId
                    },
                    error: function (xhr, error, thrown) {
                        console.error("AJAX Error:", error, thrown);
                        console.error("Response:", xhr.responseText);
    ...
    return {
        ...
        saleModal: saleModal,
        paymentpurchaseModal: paymentpurchaseModal
