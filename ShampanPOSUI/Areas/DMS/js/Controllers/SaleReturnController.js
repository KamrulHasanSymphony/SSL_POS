var SaleReturnController = function (CommonService, CommonAjaxService) {
    ...
    var GetGridDataList = function () {
        ...
        $("#GridDataList").kendoGrid({
            ...
            columns: [
                ...
                {
                    field: "DeliveryDate", title: " Delivery Date", sortable: true, width: 150
                },
                {
                ...
                { field: "RouteName", title: "Route Name", sortable: true, width: 180 },
                { field: "VehicleNo", title: "Vehicle No.", sortable: true, width: 120 },
                { field: "VehicleType", title: "Vehicle Type", sortable: true, width: 120 },
    ...
    function save($table) {
        ...
        var requiredFields = ['ProductGroupName', 'ProductName', 'UOMName', 'Quantity', 'UnitRate', 'SubTotal'];
        var fieldMappings = {
