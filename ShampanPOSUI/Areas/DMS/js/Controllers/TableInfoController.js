var TableInfoController = function (CommonService, CommonAjaxService) {

    var getBankId = 0;

    var init = function () {

        getSectionId = $("#SectionId").val();
        ...
        $('#btnPrevious').click('click', function () {
            var getId = $('#Id').val();
            if (parseInt(getId) > 0) {
                window.location.href = "/DMS/TableInfo/NextPrevious?id=" + getId + "&status=Previous";
            }
        });
        $('#btnNext').click('click', function () {
            var getId = $('#Id').val();
            if (parseInt(getId) > 0) {
                window.location.href = "/DMS/TableInfo/NextPrevious?id=" + getId + "&status=Next";
            }
        });
    ...
    function GetSectionComboBox() {
        debugger;
        var SectionIdComboBox = $("#SectionId").kendoMultiColumnComboBox({
            ...
            filter: "contains",
            filterFields: ["SectionName", "Description"],  
            dataSource: {
                transport: {
                    read: "/Common/Common/GetSectionList" 
                }
            },
            placeholder: "Select Section",
            value: "",
            dataBound: function (e) {
             if (getSectionId && getSectionId !== "0") {
            ...
            columns: [

                {
                    ...
                    template: function (dataItem) {
                        ...
                        return `
            <a href="/DMS/TableInfo/Edit/${dataItem.Id}" class="btn btn-primary btn-sm mr-2 edit" title="Edit Credit Limit">
    ...
    function save() {
        ...
        var url = "/DMS/TableInfo/CreateEdit";
