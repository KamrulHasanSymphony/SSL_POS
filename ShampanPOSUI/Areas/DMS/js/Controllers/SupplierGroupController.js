var SupplierGroupController = function (CommonAjaxService) {
    ...
    var init = function () {
        ...
        $('#btnPrevious').click('click', function () {
            var getId = $('#Id').val();
            if (parseInt(getId) > 0) {
                window.location.href = "/DMS/SupplierGroup/NextPrevious?id=" + getId + "&status=Previous";
            }
        });
        $('#btnNext').click('click', function () {
            var getId = $('#Id').val();
            if (parseInt(getId) > 0) {
                window.location.href = "/DMS/SupplierGroup/NextPrevious?id=" + getId + "&status=Next";
            }
        });
    ...
    function SelectData() {
        ...
        var url = "/DMS/SupplierGroup/Delete";
    ...
    var GetGridDataList = function () {
        ...
        var gridDataSource = new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    url: "/DMS/SupplierGroup/GetGridData",
                    type: "POST",
                    dataType: "json",
                    cache: false
                },
        ...
        $("#GridDataList").kendoGrid({
            ...
            excel: {
                fileName: "SupplierGroups.xlsx",
                filterable: true
            },
            pdf: {
                fileName: `SupplierGroups_${new Date().toISOString().split('T')[0]}_${new Date().toTimeString().split(' ')[0]}.${new Date().getMilliseconds()}.pdf`,
                allPages: true,
                avoidLink: true,
                filterable: true
            },
            ...
            columns: [
                ...
                },
                {
                    ...
                    template: function (dataItem) {
                        ...
                        return `
                                <a href="/DMS/SupplierGroup/Edit/${dataItem.Id}" class="btn btn-primary btn-sm mr-2 edit">
    ...
    function save() {
        ...
        var url = "/DMS/SupplierGroup/CreateEdit";
