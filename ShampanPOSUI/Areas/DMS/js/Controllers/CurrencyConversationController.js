var CurrencyConversationController = function (CommonAjaxService) {
    ...
    var init = function () {
        ...
        CurrencieFromComboBox();
        CurrencieToComboBox();

        function CurrencieFromComboBox() {
            var ProductGroupComboBox = $("#FromId").kendoMultiColumnComboBox({
                dataTextField: "Name",
                dataValueField: "Id",
                height: 400,
                columns: [
        ...
        function CurrencieToComboBox() {
            var ProductGroupComboBox = $("#ToId").kendoMultiColumnComboBox({
                dataTextField: "Name",
                dataValueField: "Id",
                height: 400,
                columns: [
    ...
    function SelectData() {
        ...
        var url = "/DMS/CurrencyConversation/Delete";
    ...
    var GetGridDataList = function () {
        ...
        var gridDataSource = new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    url: "/DMS/CurrencyConversation/GetGridData",
                    type: "POST",
                    dataType: "json",
                    cache: false
                },
        ...
        $("#GridDataList").kendoGrid({
            ...
            pdf: {
                fileName: `CurrencyConversations_${new Date().toISOString().split('T')[0]}_${new Date().toTimeString().split(' ')[0]}.${new Date().getMilliseconds()}.pdf`,
                allPages: true,
                avoidLink: true,
                filterable: true
            },
            pdfExport: function (e) {
                ...
                var fileName = `CurrencyConversations_${new Date().toISOString().split('T')[0]}_${new Date().toTimeString().split(' ')[0]}.${new Date().getMilliseconds()}.pdf`;
            ...
            columns: [
                ...
                },
                {
                    ...
                    template: function (dataItem) {
                        ...
                        return `
                            <a href="/DMS/CurrencyConversation/Edit/${dataItem.Id}" class="btn btn-primary btn-sm mr-2 edit">
    ...
    function save() {
        ...
        var url = "/DMS/CurrencyConversation/CreateEdit";
