var WithdrawalController = function (CommonService, CommonAjaxService) {
    ...
    var init = function () {
        ...
        $('#btnPrevious').click('click', function () {
            var getId = $('#Id').val();
            if (parseInt(getId) > 0) {
                window.location.href = "/DMS/Withdrawal/NextPrevious?id=" + getId + "&status=Previous";
            }
        });
        $('#btnNext').click('click', function () {
            var getId = $('#Id').val();
            if (parseInt(getId) > 0) {
                window.location.href = "/DMS/Withdrawal/NextPrevious?id=" + getId + "&status=Next";
            }
        });
    ...
    //        transport: {
    //            read: {
    //                url: "/DMS/Withdrawal/GetGridData",
    //                type: "POST",
    //                dataType: "json",
    //                cache: false
    //            },
    ...
    //        },
    //        pdf: {
    //            fileName: `Withdrawals_${new Date().toISOString().split('T')[0]}_${new Date().toTimeString().split(' ')[0]}.${new Date().getMilliseconds()}.pdf`,
    //            allPages: true,
    //            avoidLink: true,
    //            filterable: true
    //        },
    ...
    //            var fileName = `Withdrawals_${new Date().toISOString().split('T')[0]}_${new Date().toTimeString().split(' ')[0]}.${new Date().getMilliseconds()}.pdf`;
    ...
    //                    return `
    //        <a href="/DMS/Withdrawal/Edit/${dataItem.Id}" class="btn btn-primary btn-sm mr-2 edit" title="Edit Credit Limit">
    ...
    function save() {
        ...
        var url = "/DMS/Withdrawal/CreateEdit";
...
function ReportPreview(id) {
    ...
    form.method = 'post';
    form.action = '/DMS/BankInformation/ReportPreview';
    form.target = '_blank';
