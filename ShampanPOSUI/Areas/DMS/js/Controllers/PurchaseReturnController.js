    ...
    var GetGridDataList = function () {
        ...
        $("#GridDataList").kendoGrid({
            ...
            pdfExport: function (e) {
                ...
                var fileName = `PurchaseReturn_${new Date().toISOString().split('T')[0]}_${new Date().toTimeString().split(' ')[0]}.${new Date().getMilliseconds()}.pdf`;
    ...
    function saveDone(result) {
        ...
        if (result.Status == 200) {
            if (result.Data.Operation == "add") {
                ...
                // 🔥 Redirect with ID
                window.location.href = "/DMS/PurchaseReturn/Edit/" + id;
            }
            else {
                ShowNotification(1, result.Message);
