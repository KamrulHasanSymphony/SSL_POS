var PurchaseOrderController = function (CommonService, CommonAjaxService) {
    ...
    var init = function () {
                ...
                function (result) {
                    ...
                    if (result) {
                        ...
                        if (model.IsPost == "True") {
                            ...
                            model.IDs = model.Id;
                            var url = "/DMS/PurchaseOrder/MultiplePost";
        ...
        $('#btnPrevious').click('click', function () {
            var getId = $('#Id').val();
            if (parseInt(getId) > 0) {
                window.location.href = "/DMS/PurchaseOrder/NextPrevious?id=" + getId + "&status=Previous";
            }
        });
        ...
        $('#btnNext').click('click', function () {
            var getId = $('#Id').val();
            if (parseInt(getId) > 0) {
                window.location.href = "/DMS/PurchaseOrder/NextPrevious?id=" + getId + "&status=Next";
            }
        });
    ...
    function TotalDCalculation() {
        ...
        $('#details tbody tr').each(function () {
            ...
            totals.sdAmount += parseFloat(row.find('.td-SD').text().replace(/,/g, '')) || 0;
    ...
    function GetSupplierComboBox() {
        var SupplierComboBox = $("#SupplierId").kendoMultiColumnComboBox({
            ...
            placeholder: "Select Supplier", // Set the placeholder
            value: "",
    ...
    var GetGridDataList = function () {
        ...
        var gridDataSource = new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    url: "/DMS/PurchaseOrder/GetGridData",
                    type: "POST",
                    dataType: "json",
                    cache: false,
        ...
        $("#GridDataList").kendoGrid({
            ...
            search: ["Code", "SupplierName", "SupplierAddress", "Status", "Completed", "OrderDate", "DeliveryDateTime", "Comments", "TransactionType", "BranchName"],
            ...
            //                                        <p><strong>Order Date : </strong> ${masterRow.OrderDate}</p>
            //                                        <p><strong>Supplier Name : </strong> ${masterRow.SupplierName}</p>
            //                                        <p><strong>Posted Status : </strong> ${masterRow.Status}</p>
            //                                    </div>
            //                                    <div style="width: 50%; padding: 5px;">
            //                                        <p><strong>Delivery Date : </strong> ${masterRow.DeliveryDateTime}</p>
    ...
    function save($table) {
        ...
        var url = "/DMS/PurchaseOrder/CreateEdit";
    ...
    function SelectDataForComplete() {
        ...
        var url = "/DMS/PurchaseOrder/MultipleIsCompleted";
...
function ReportPreview(id) {
    ...
    form.method = 'post';
    form.action = '/DMS/PurchaseOrder/ReportPreview';
    form.target = '_blank';
