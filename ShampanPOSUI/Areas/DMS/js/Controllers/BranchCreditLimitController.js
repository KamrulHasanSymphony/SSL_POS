var BranchCreditLimitController = function (CommonAjaxService) {
    var getBranchId = 0;
    var init = function () {
    ...
    function SelectData() {   
        ...
        var url = "/DMS/BranchCreditLimit/MultiplePost";
    ...
    function save() {
        ...
        model.SelfCreditLimit = model.SelfCreditLimit.replace(/,/g, '');
        model.OtherCreditLimit = model.OtherCreditLimit.replace(/,/g, '');
        var url = "/DMS/BranchCreditLimit/CreateEdit";
