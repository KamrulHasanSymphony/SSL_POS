var BranchAdvanceController = function (CommonAjaxService) {
    var getBranchId = 0;
    ...
    var init = function () {
        ...
        if (!isIndex) {
            GetPaymentEnumTypeComboBox();
            GetReceiveByEnumTypeComboBox();
        } 
    ...
    function SelectData() {
        ...
        var url = "/DMS/BranchAdvance/MultiplePost";
    ...
    function GetPaymentEnumTypeComboBox() {
        var ProductGroupComboBox = $("#PaymentEnumTypeId").kendoMultiColumnComboBox({
            dataTextField: "Name",
            dataValueField: "Id",
            height: 400,
            columns: [                
            ...
            dataSource: {
                transport: {
                    read: "/Common/Common/GetAreaEnumTypeList?value=PaymentType"
                }
            },
            placeholder: "Select Payment Enum Type ", // Set the placeholder
            value: "",
            dataBound: function (e) {
    ...
    function GetReceiveByEnumTypeComboBox() {
        var ProductGroupComboBox = $("#ReceiveByEnumTypeId").kendoMultiColumnComboBox({
            dataTextField: "Name",
            dataValueField: "Id",
            height: 400,
            columns: [
            ...
            dataSource: {
                transport: {
                    read: "/Common/Common/GetAreaEnumTypeList?value=ReceiveType"
                }
            },
            placeholder: "Select Receive Enum Type ", // Set the placeholder
            value: "",
            dataBound: function (e) {
    ...
    function save() {
        ...
        var url = "/DMS/BranchAdvance/CreateEdit";
