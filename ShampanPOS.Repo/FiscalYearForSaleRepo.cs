...
{
    public class FiscalYearForSaleRepo
    {
        public ResultVM Dropdown()
        {
            try
            {
                ...
                #region Invoke API
                var data = httpRequestHelper.PostData("/api/FiscalYearForSale/Dropdown", authModel, JsonConvert.SerializeObject(authModel));
        ...
        public ResultVM List(CommonVM model)
        {
            try
            {
                ...
                AuthModel authModel = new AuthModel { token = ClaimNames.token };
                #region Invoke API
                var data = httpRequestHelper.PostData("api/FiscalYearForSale/List", authModel, JsonConvert.SerializeObject(model));
                ResultVM result = JsonConvert.DeserializeObject<ResultVM>(data);
                #endregion                
        ...
        public ResultVM Insert(FiscalYearForSaleVM model)
        {
            try
            {
                HttpRequestHelper httpRequestHelper = new HttpRequestHelper();
                AuthModel authModel = new AuthModel { token = ClaimNames.token };
                #region Invoke API
                var data = httpRequestHelper.PostData("api/FiscalYearForSale/Insert", authModel, JsonConvert.SerializeObject(model));
                ResultVM result = JsonConvert.DeserializeObject<ResultVM>(data);
                #endregion                
        ...
        public ResultVM Update(FiscalYearForSaleVM model)
        {
            try
            {
                HttpRequestHelper httpRequestHelper = new HttpRequestHelper();
                AuthModel authModel = new AuthModel { token = ClaimNames.token };
                #region Invoke API
                var data = httpRequestHelper.PostData("api/FiscalYearForSale/Update", authModel, JsonConvert.SerializeObject(model));
                ResultVM result = JsonConvert.DeserializeObject<ResultVM>(data);
                #endregion                
        ...
        public ResultVM Delete(CommonVM model)
        {
            try
            {
                ...
                AuthModel authModel = new AuthModel { token = ClaimNames.token };
                #region Invoke API
                var data = httpRequestHelper.PostData("api/FiscalYearForSale/Delete", authModel, JsonConvert.SerializeObject(model));
                ResultVM result = JsonConvert.DeserializeObject<ResultVM>(data);
                #endregion                
        ...
        public ResultVM GetGridData(GridOptions options)
        {
            try
            {
                ...
                var data = httpRequestHelper.PostData("api/FiscalYearForSale/GetGridData", authModel, JsonConvert.SerializeObject(options,
        ...
        public List<FiscalYearForSaleVM> GetFiscalYearsList()
        {
            try
            {
                ...
                return kendoList.Select_Data_ListCMD<FiscalYearForSaleVM>(sqlQuery);
            }
            catch (Exception ex)
            {
                throw ex.InnerException;
