var TableSectionController = function (CommonService, CommonAjaxService) {
    ...
    var init = function () {
        ...
        $('#btnPrevious').click('click', function () {
            var getId = $('#Id').val();
            if (parseInt(getId) > 0) {
                window.location.href = "/DMS/TableSection/NextPrevious?id=" + getId + "&status=Previous";
            }
        });
        $('#btnNext').click('click', function () {
            var getId = $('#Id').val();
            if (parseInt(getId) > 0) {
                window.location.href = "/DMS/TableSection/NextPrevious?id=" + getId + "&status=Next";
            }
        });
    ...
    function SelectData() {
        ...
        var url = "/DMS/TableSection/Delete";
    ...
    var GetGridDataList = function () {
        ...
        var gridDataSource = new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    url: "/DMS/TableSection/GetGridData",
                    type: "POST",
                    dataType: "json",
                    cache: false
                },
        ...
        $("#GridDataList").kendoGrid({
            ...
            search: {
                fields: ["SectionName", "Description", "Status"]
            },
            excel: {
                fileName: "TableSection.xlsx",
                filterable: true
            },
            pdf: {
                fileName: `TableSection_${new Date().toISOString().split('T')[0]}_${new Date().toTimeString().split(' ')[0]}.${new Date().getMilliseconds()}.pdf`,
                allPages: true,
                avoidLink: true,
                filterable: true
            },
            pdfExport: function (e) {
                ...
                var fileName = `TableSection_${new Date().toISOString().split('T')[0]}_${new Date().toTimeString().split(' ')[0]}.${new Date().getMilliseconds()}.pdf`;
            ...
            columns: [

                {
                    ...
                    template: function (dataItem) {
                        ...
                        return `
            <a href="/DMS/TableSection/Edit/${dataItem.Id}" class="btn btn-primary btn-sm mr-2 edit" title="Edit Credit Limit">
    ...
    function save() {
        ...
        var url = "/DMS/TableSection/CreateEdit";
