var ProductReplaceIssueController = function (CommonService, CommonAjaxService) {
                ...
                function (result) {
                    ...
                    if (result) {
                        ...
                        if (model.IsPost == "True") {
                            ...
                            model.IDs = model.Id;
                            var url = "/DMS/ProductReplaceIssue/MultiplePost";
    ...
    var GetGridDataList = function () {
        ...
        var gridDataSource = new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    url: "/DMS/ProductReplaceIssue/GetGridData",
                    type: "POST",
                    dataType: "json",
                    cache: false,
        ...
        $("#GridDataList").kendoGrid({
            ...
            detailInit: function (e) {
                ...
                $("<div/>").appendTo(e.detailCell).kendoGrid({
                    dataSource: {
                        ...
                        transport: {
                            read: {
                                url: "/DMS/ProductReplaceIssue/GetProductReplaceIssueDetailDataById",
                                type: "GET",
                                dataType: "json",
                                cache: false,
            ...
            ,
            excel: {
                fileName: "ProductReplaceIssueList.xlsx",
                filterable: true
            },
            pdf: {
                fileName: `ProductReplaceIssueList_${new Date().toISOString().split('T')[0]}_${new Date().toTimeString().split(' ')[0]}.${new Date().getMilliseconds()}.pdf`,
                allPages: true,
                avoidLink: true,
                filterable: true
            },
            pdfExport: function (e) {
                ...
                var fileName = `ProductReplaceIssueList_${new Date().toISOString().split('T')[0]}_${new Date().toTimeString().split(' ')[0]}.${new Date().getMilliseconds()}.pdf`;
            ...
            columns: [
                ...
                },
                {
                    ...
                    template: function (dataItem) {
                        return `
            <a href="/DMS/ProductReplaceIssue/Edit/${dataItem.Id}"
            ...
            `
                ...
                {
                    field: "IssueDate", title: "Issue Date", sortable: true, width: 150, template: '#= kendo.toString(kendo.parseDate(IssueDate), "yyyy-MM-dd") #',
                    filterable:
                    {
                        ui: "datepicker"
                    }
    ...
    function save($table) {
        ...
        model.ProductReplaceIssueDetails = details;

        var url = "/DMS/ProductReplaceIssue/CreateEdit";
