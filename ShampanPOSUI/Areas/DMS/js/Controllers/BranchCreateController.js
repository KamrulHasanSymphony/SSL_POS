var BranchCreateController = function (CommonService, CommonAjaxService) {
    var getEnumTypeId = 0;
    var getAreaId = 0;
    var getParentId = 0;
    var getName = "";
    ...
    function GetAreaComboBox() {
        ...
        var AreaComboBox = $("#AreaId").kendoMultiColumnComboBox({
            ...
            value: "",
            dataBound: function (e) {
                var data = this.dataSource.view(); // current visible data
    ...
    function save() {
        ...
        var url = "/DMS/BranchCreate/BranchCreateEdit";
