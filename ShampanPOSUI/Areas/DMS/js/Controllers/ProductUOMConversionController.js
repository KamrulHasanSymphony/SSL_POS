var ProductUOMConversionController = function (CommonAjaxService) {
    ...
    function SelectData() {
        ...
        var url = "/DMS/ProductPurchasePriceBatchHistorie/Delete";
        ...
        $("#GridDataList").kendoGrid({
            ...
            pdfExport: function (e) {
                ...
                $.ajax({
                    ...
                    type: "GET",
                    dataType: "json",
                    data: { productId: 0, tblName: 'ProductPurchasePriceBatchHistories' },
                    async: false,
    ...
    function save() {
        ...
        if (model.ConversationFactor <= -1) {
            ShowNotification(3, "Negative Conversion Factor Is Not Allow");
            return;
        }
        ...
        var url = "/DMS/ProductUOMConversion/CreateEdit";
