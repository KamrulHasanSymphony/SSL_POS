        ...
        $("#GridDataList").kendoGrid({
          ...
          /*  search: ["Code", "SupplierName", "SupplierAddress", "Status", "Completed", "BENumber", "OrderDate", "DeliveryDateTime", "GrandTotalAmount", "GrandTotalSDAmount", "GrandTotalVATAmount", "Comments", "TransactionType", "CurrencyRateFromBDT", "CurrencyName", "FiscalYear", "BranchName", "BranchAddress"],*/
            ...
            columns: [
                ...
                {
                    field: "PurchaseReturnDate", title: "Invoice Date", sortable: true, width: 150, template: '#= kendo.toString(kendo.parseDate(PurchaseReturnDate), "yyyy-MM-dd") #',
                    filterable:
                    {
                        ui: "datepicker"
                    }
                ...
                { field: "ImportIDExcel", title: "Import IDExcel", sortable: true, width: 150 },
                { field: "FiscalYear", title: "Fiscal Year", sortable: true, width: 130 },
                { field: "CurrencyRateFromBDT", title: "Currency Rate FromBDT", sortable: true, width: 200 },
