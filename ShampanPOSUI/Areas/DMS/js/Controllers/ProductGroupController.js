var ProductGroupController = function (CommonAjaxService) {
    ...
    var init = function () {
        ...
        $('#btnPrevious').click('click', function () {
            var getId = $('#Id').val();
            if (parseInt(getId) > 0) {
                window.location.href = "/DMS/ProductGroup/NextPrevious?id=" + getId + "&status=Previous";
            }
        });
        $('#btnNext').click('click', function () {
            var getId = $('#Id').val();
            if (parseInt(getId) > 0) {
                window.location.href = "/DMS/ProductGroup/NextPrevious?id=" + getId + "&status=Next";
            }
        });
    };
    ...
    function SelectData() {
        ...
        var url = "/DMS/ProductGroup/Delete";
    ...
    var GetGridDataList = function () {
        ...
        var gridDataSource = new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    url: "/DMS/ProductGroup/GetGridData",
                    type: "POST",
                    dataType: "json",
                    cache: false
                },
        ...
        $("#GridDataList").kendoGrid({
            ...
            excel: {
                fileName: "ProductGroups.xlsx",
                filterable: true
            },
            pdf: {
                fileName: `ProductGroups_${new Date().toISOString().split('T')[0]}_${new Date().toTimeString().split(' ')[0]}.${new Date().getMilliseconds()}.pdf`,
                allPages: true,
                avoidLink: true,
                filterable: true
            },
    ...
    function save() {
        ...
        var url = "/DMS/ProductGroup/CreateEdit";
