...
namespace ShampanPOS.Repo
{
    public class MasterSupplierRepo
    {
        ...
        public ResultVM InsertSupplierFromMasterSupplier(SupplierVM model)
        {
            try
            {
                ...
                var data = httpRequestHelper.PostData("api/Supplier/InsertFromMasterSupplier", authModel, JsonConvert.SerializeObject(model));
        ...
        public ResultVM MasterUpdate(SupplierVM model)
        {
            try
            {
                HttpRequestHelper httpRequestHelper = new HttpRequestHelper();
