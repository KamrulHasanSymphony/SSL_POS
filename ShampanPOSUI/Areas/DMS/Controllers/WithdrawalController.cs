...
namespace ShampanPOSUI.Areas.DMS.Controllers
{
    ...
    public class WithdrawalController : Controller
    {
        ...
        WithdrawalRepo _repo = new WithdrawalRepo();
        ...
        [HttpPost]
        public ActionResult CreateEdit(WithdrawalVM model)
        {
            ResultModel<WithdrawalVM> result = new ResultModel<WithdrawalVM>();
            ResultVM resultVM = new ResultVM { Status = "Fail", Message = "Error", ExMessage = null, Id = "0", DataVM = null };
            _repo = new WithdrawalRepo();
            ...
            try
            {
                if (model.Operation.ToLower() == "add")
                {
                    ...
                    {
                        model = JsonConvert.DeserializeObject<WithdrawalVM>(resultVM.DataVM.ToString());
                        model.Operation = "add";
                        Session["result"] = resultVM.Status + "~" + resultVM.Message;
                        result = new ResultModel<WithdrawalVM>()
                        {
                            Success = true,
        ...
        public ActionResult Edit(string id)
        {
            try
            {
                ...
                {
                    vm = JsonConvert.DeserializeObject<List<WithdrawalVM>>(result.DataVM.ToString()).FirstOrDefault();
                }
                else
                {
                    vm = null;
        ...
        [HttpPost]
        public ActionResult Delete(WithdrawalVM vm)
        {
            ResultModel<WithdrawalVM> result = new ResultModel<WithdrawalVM>();
        ...
        public JsonResult GetGridData(GridOptions options)
        {
            ...
            try
            {
                ...
                if (result.Status == "Success" && result.DataVM != null)
                {
                    var gridData = JsonConvert.DeserializeObject<GridEntity<WithdrawalVM>>(result.DataVM.ToString());
