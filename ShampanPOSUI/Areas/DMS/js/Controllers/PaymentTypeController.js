var PaymentTypeController = function (CommonAjaxService) {
    ...
    function SelectData() {
        ...
        var url = "/DMS/PaymentType/Delete";
    ...
    var GetGridDataList = function () {
        ...
        var gridDataSource = new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    url: "/DMS/PaymentType/GetGridData",
                    type: "POST",
                    dataType: "json",
                    cache: false
                },
        ...
        $("#GridDataList").kendoGrid({
            ...
            excel: {
                fileName: "PaymentTypes.xlsx",
                filterable: true
            },

            pdf: {
                fileName: `PaymentTypes_${new Date().toISOString().split('T')[0]}_${new Date().toTimeString().split(' ')[0]}.${new Date().getMilliseconds()}.pdf`,
                allPages: true,
                avoidLink: true,
                filterable: true
            },
            pdfExport: function (e) {
                ...
                var fileName = `PaymentTypes_${new Date().toISOString().split('T')[0]}_${new Date().toTimeString().split(' ')[0]}.${new Date().getMilliseconds()}.pdf`;
            ...
            columns: [
                ...
                },
                {
                    ...
                    template: function (dataItem) {
                        ...
                        return `
                                <a href="/DMS/PaymentType/Edit/${dataItem.Id}" class="btn btn-primary btn-sm mr-2 edit">
    ...
    function save() {
        ...
        var url = "/DMS/PaymentType/CreateEdit";
...
function ReportPreview(id) {
    ...
    form.method = 'post';
    form.action = '/DMS/PaymentType/ReportPreview';
    form.target = '_blank';
