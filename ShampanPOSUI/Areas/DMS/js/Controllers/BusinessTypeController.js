var BusinessTypeController = function (CommonAjaxService) {
    var init = function () {
        ...
        $('#btnPrevious').click('click', function () {
            var getId = $('#Id').val();
            if (parseInt(getId) > 0) {
                window.location.href = "/DMS/BusinessType/NextPrevious?id=" + getId + "&status=Previous";
            }
        });
        $('#btnNext').click('click', function () {
            var getId = $('#Id').val();
            if (parseInt(getId) > 0) {
                window.location.href = "/DMS/BusinessType/NextPrevious?id=" + getId + "&status=Next";
            }
        });
    };
    ...
    function SelectData() {
        ...
        var url = "/DMS/BusinessType/Delete";
    ...
    var GetGridDataList = function () {
        ...
        var gridDataSource = new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    url: "/DMS/BusinessType/GetGridData",
                    type: "POST",
                    dataType: "json",
                    cache: false
                },
        ...
        $("#GridDataList").kendoGrid({
            ...
            excel: {
                fileName: "BusinessTypes.xlsx",
                filterable: true
            },
            pdf: {
                fileName: `BusinessTypes_${new Date().toISOString().split('T')[0]}_${new Date().toTimeString().split(' ')[0]}.${new Date().getMilliseconds()}.pdf`,
                allPages: true,
                avoidLinks: true,
                filterable: true
            },
            pdfExport: function (e) {
                ...
                var fileName = `BusinessTypes_${new Date().toISOString().split('T')[0]}_${new Date().toTimeString().split(' ')[0]}.${new Date().getMilliseconds()}.pdf`;
            ...
            columns: [
                ...
                },
                {
                    ...
                    template: function (dataItem) {
                        return `
                            <a href="/DMS/BusinessType/Edit/${dataItem.Id}" class="btn btn-primary btn-sm mr-2 edit">
    ...
    function save() {
        ...
        var url = "/DMS/BusinessType/CreateEdit";
...
function ReportPreview(id) {
    ...
    form.method = 'post';
    form.action = '/DMS/BusinessType/ReportPreview';
    form.target = '_blank';
