var CompanyCreateController = function (CommonAjaxService) {
    ...
    function save() {
        ...
        var url = "/SetUp/CompanyCreate/CreateEdit";
    ...
    function saveDone(result) {
        ...
        if (result.Status == 200) {
            ...
            var data = result.Data || {};   // ✅ FIX ADDED
            ...
            if (data.Operation == "add") {
                ...
                $("#LastModifiedOn").val(data.LastModifiedOn);
            }

            // ✅ REDIRECT
            setTimeout(function () {
                window.location.href = "/DMS/BranchCreate/BranchCreate?companyId="
