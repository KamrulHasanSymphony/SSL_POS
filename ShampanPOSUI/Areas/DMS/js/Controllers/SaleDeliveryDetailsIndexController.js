var SaleDeliveryDetailsIndexController = function (CommonService, CommonAjaxService) {
    ...
    var GetGridDetailsDataList = function () {
        ...
        var gridDataSource = new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    url: "/SaleDelivery/GetDetailsGridData",
                    type: "POST",
                    dataType: "json",
                    cache: false,
        ...
        $("#GridDetailsDataList").kendoGrid({
            ...
            excel: {
                fileName: `SaleDelivery_Details_${new Date().toISOString().split('T')[0]}.xlsx`,
                filterable: true
            },
            pdf: {
                fileName: `SaleDelivery_Details_${new Date().toISOString().split('T')[0]}_${new Date().toTimeString().split(' ')[0]}.${new Date().getMilliseconds()}.pdf`,
                allPages: true,
                avoidLink: true,
                filterable: true
            },
            pdfExport: function (e) {
                ...
                var fileName = `SaleDelivery_Details_${new Date().toISOString().split('T')[0]}_${new Date().toTimeString().split(' ')[0]}.${new Date().getMilliseconds()}.pdf`;
